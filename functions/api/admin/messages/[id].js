...
import { getContactMessage, updateContactMessageStatus, deleteContactMessage, logAdminAction, jsonResponse, getEmailLogForRelated } from "../../../_shared/db.js";
...
export async function onRequestGet({ request, env, params }) {
  try {
    ...
    const emailLog = await getEmailLogForRelated(env, "contact_message", params.id);
    return jsonResponse({ ok: true, message, emailLog });
  } catch (err) {
